    ...
    public class pedidosController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pedidos = await _context.pedidos
                .FirstOrDefaultAsync(m => m.pedidold == id);
            if (pedidos == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("pedidold,motoristald,clienteld,platold,cantidad,precio")] pedidos pedidos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("pedidold,motoristald,clienteld,platold,cantidad,precio")] pedidos pedidos)
        {
            if (id != pedidos.pedidold)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!pedidosExists(pedidos.pedidold))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.pedidos?.Any(e => e.pedidold == id)).GetValueOrDefault();
        }
    }
}
